...
<xsl:param name="collection" select="collection(hase-uri())"/>
    ...
    <xsl:template name="marcRecord">
            ...
            <originInfo eventType="producer">
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <place>
                            <placeTerm type="text">
                                <xsl:value-of select="replace(marc:subfield[@code = 'a'],'\[(.*)\?\]\s+?[:;,.()]?\s+?','$1')"/>
                            </placeTerm>
                        </place>
                        <publisher>
        ...
        <!-- 1.180 -->
        <xsl:if test="marc:datafield[@tag = '655']/marc:subfield[@code = 'a'] != 'article' and not(matches(marc:datafield[@tag = '773'][1]/marc:subfield[@code = 'x'][1], '\d{4}\-\d{3}.'))">
            <xsl:choose>
                <xsl:when test="
...
<!--        <xsl:for-each
   ...
   <!--     <!-\- 1.147 -\->
        <xsl:for-each select="marc:datafield[@tag = '072'][@ind2 = '0']">
           <xsl:variable name="subjCode" select="marc:subfield[@code = 'a']"/>
            <!-\- 1.191-\->
            <xsl:for-each select="marc:subfield[@code = 'a']">
            <!-\-<xsl:choose>
                <xsl:when test="matches(marc:subfield[@code = 'a'], '[A-K][0-9][0-6][0-3]') and not(marc:subfield[@code = 'a']='')">-\->
            ...
            <xsl:if test="count(marc:subfield[@code = 'a']) > 1">
                <xsl:message terminate="no">
                    ...
                    <xsl:value-of select="/marc:record/marc:controlfield[@tag = '001']"/>
...
-->
        ...
        <xsl:for-each select="marc:datafield[@tag = '072'][@ind2 = '0']">
            <!-- 1.191-->
            <xsl:for-each select="marc:subfield[@code = 'a']">
                <xsl:variable name="subjectPhrase">
                        <xsl:value-of select="f:subjCatCode(.)"/>
                </xsl:variable>
       
          <!-- 1.212 -->
            <xsl:if test="$subjectPhrase !=''">
                <subject authority="agricola">
                    <topic>
                        <xsl:value-of select="$subjectPhrase"/>
                    </topic>
                </subject>
            </xsl:if>
            <xsl:if test="count(marc:subfield[@code = 'a']) > 1">
        ...
        <!-- 1.160 -->
        <xsl:for-each select="marc:datafield[@tag = '070'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '070')]">
     ...
     <!--   <xsl:for-each
                                ...
                                <part>
                                    ...
                                    <xsl:analyze-string select="." regex="(\d+)\s?(\w+)?\.?\s?(\d+)?(.+)">
                                        <xsl:matching-substring>
                                            <!-- 1.203 -->
                                            <xsl:if test="replace(substring-after(regex-group(4), 'v.'), '(\s)?(\d+)(.*)', '$2')!=''">
                                            <!-- volume -->
                                            <detail type="volume">
                                                <number>
                                                  <xsl:value-of select="replace(substring-after(regex-group(4), 'v.'), '(\s)?(\d+)(.*)', '$2')"/>
                                                </number>
                                                <caption>v.</caption>
                                            </detail>
                                            </xsl:if>
                                            ...
                                            <xsl:if test="matches(regex-group(4), 'no. ')">
                                                <detail type="issue">
                                                  <number>
                                                  <xsl:value-of select="replace(substring-after(regex-group(4), 'no.'), '(\s)?(\d+)(.*)', '$2')"/>
                                                  </number>
                                                  <caption>no.</caption>
                                                </detail>
                                            </xsl:if>
                                            <xsl:if test="matches(regex-group(4), 'pt. ')">
                                                <detail type="issue">
                                                  <number>
                                                  <xsl:value-of select="replace(substring-after(regex-group(4), 'pt.'), '(\s)?(\d+)(.*)', '$2')"/>
                                                  </number>
                                                  <caption>no.</caption>
                                                </detail>
                                            </xsl:if>
                                            <xsl:choose>
                                                ...
                                                <xsl:when test="matches(substring-after(regex-group(4), 'p.'), '\d+\-\d+')">
                                                  ...
                                                  <total>
                                                  <xsl:value-of select="translate(f:modsTotalPgs($startPage, $endPage), $alpha, '')"/>
                                                  </total>
                                                  </xsl:if>
                                                  </xsl:otherwise>
                                                  </xsl:choose>
        ...
        <xsl:for-each select="marc:datafield[@tag = '010'][marc:subfield[@code = 'z']]">
            <identifier type="lccn" invalid="yes">
                <xsl:value-of select="normalize-space(marc:subfield[@code = 'z'][1])"/>
            </identifier>
        </xsl:for-each>
        ...
        <xsl:for-each select="marc:datafield[@tag = '856'][marc:subfield[@code = 'u']]">
            <xsl:if test="starts-with(marc:subfield[@code = 'u'][1], 'urn:hdl') or starts-with(marc:subfield[@code = 'u'][1], 'hdl') or starts-with(marc:subfield[@code = 'u'][1], 'http://hdl.loc.gov')">
                <identifier>
                    <xsl:attribute name="type">
                        <xsl:if test="starts-with(marc:subfield[@code = 'u'][1], 'urn:doi') or starts-with(marc:subfield[@code = 'u'][1], 'doi')">doi</xsl:if>
            ...
            <xsl:if test="starts-with(marc:subfield[@code = 'u'][1], 'urn:hdl') or starts-with(marc:subfield[@code = 'u'][1], 'hdl')">
                <identifier type="hdl">
...
<!-- 1.205 -->       
        ...
        <recordInfo>
            ...
            <recordOrigin>
                ...
                <xsl:value-of select="normalize-space(concat('Converted from MARCXML to MODS version 3.7 using', ' ', $transform, ' ', '(Revision ',$revisionNumber,' ',$revisionDate,' cm3),'))"/>
                <xsl:text>&#xa0;</xsl:text>
...
<!--end marc:record template-->
    ...
    <xsl:template match="marc:subfield[@code='a']" mode="award-id">
            <xsl:for-each select="tokenize(normalize-space(.), '\s*,\s*')">
                <award-id>
                    <xsl:value-of select="."/>
                </award-id>
            </xsl:for-each>
    ...
    <!--1.165 -->
    <xd:doc id="personal_name" scope="component"><xd:desc><xd:p>formerly named displayForm template</xd:p><xd:p>this template selects and builds marc datafields @100/@700.</xd:p></xd:desc><xd:param name="name"/></xd:doc>
    ...
    <xsl:template name="affiliation">
        <xsl:for-each select="marc:subfield[@code='u'][text()!='']">
            <affiliation>
                <xsl:value-of select="normalize-space(.)"/>
            </affiliation>
         </xsl:for-each>
    ...
    <xsl:template name="nameIdentifier"><!--1.201 -->
        <!--$0 - Authority record control number or standard number (R)-->        
        <xsl:for-each select="marc:subfield[@code='0']">
            <nameIdentifier> <!--type="{f:nameIdentifier(.)}">-->
                <xsl:value-of select="if (starts-with(., 'http://id.loc.gov/authorities/names/')) then concat('https://id.loc.gov/rwo/agents/',tokenize(., '/')[last()]) else ."/>
            </nameIdentifier>
        </xsl:for-each>
    ...
    <xd:doc>
        <xd:desc>createRelatedOriginInfo</xd:desc>
    </xd:doc>
    <xsl:template name="createRelatedOriginInfo">
        <originInfo>
        <xsl:if test="marc:datafield[@tag='776' or @tag='787']">
            <xsl:analyze-string select="string(marc:subfield[@code='f'])" regex="(.*?)(\w+?\s?\w+\s?)?(\s;\s|\s:\s|,|\[.*\])(\w+\s+)?(.*;)?(.*:)?(.*)(,|\[)(.*)">
                <xsl:matching-substring>
                    <!-- place -->
                    <place>
                        <placeTerm type="text">
    ...
    <xd:doc id="xlink" scope="component">
        <xd:p>marc:subfield[@code = '0']</xd:p>
        <xd:p> Authority record control number or standard number</xd:p>
    </xd:doc>
    <xsl:template match="marc:subfield[@code = '0']" mode="xlink" xmlns:xlink="http://www.w3.org/1999/xlink">
        <xsl:attribute name="xlink:href">
            ...
            <xsl:choose>
                <!-- convert URN to URL -->
                <xsl:when test="matches(.,'.*\(OCoLC\)fst0\d+.*')">
                    <xsl:variable name="fastId" select="replace(substring-after(., '(OCoLC)fst'),'^0+','')"/>
                    <xsl:value-of select="if (string($fastId)!='NaN') then concat('https://id.worldcat.org/fast/', $fastId) else ."/>
                </xsl:when>
                <!-- viaf -->
    ...
    <xd:doc id="xlink" scope="component">
        <xd:desc>
            <xd:p>marc:subfield[@code = '1']</xd:p>
            <xd:p>Real World Object URI</xd:p>
        </xd:desc>
    </xd:doc>
    <xsl:template match="marc:subfield[@code = '1']" mode="xlink" xmlns:xlink="http://www.w3.org/1999/xlink">
        <xsl:attribute name="xlink:href">
            <!-- 1.198 -->
            <xsl:value-of select="."/>
        </xsl:attribute>
    ...
    <xsl:template name="relatedForm">
        <xsl:if test="marc:subfield[@code = 'h'] and marc:datafield[@tag = '655']/marc:subfield[@code = 'a'] != 'article' and not(matches(marc:datafield[@tag = '773']/marc:subfield[@code = 'x'], '\d{4}\-\d{3}.'))">
    ...
    <xd:doc id="relatedExtent" scope="component">
        <xd:desc>marc:300 relatedExtent </xd:desc>
    </xd:doc>
    ...
    <xd:doc id="relatedItemNames" scope="component">
        <xd:desc> 1.121 Creates related item names mode="relatedItem" </xd:desc>
    </xd:doc>
    ...
    <xsl:template name="subjectTopic" xmlns:xlink="http://www.w3.org/1999/xlink">
        <topic>
            <xsl:call-template name="chopPunctuation">
                <xsl:with-param name="chopString" select="."/>
            </xsl:call-template>
    ...
    <xd:doc>
        <xd:desc>match "marc:datafield[@tag = '656']</xd:desc>
    </xd:doc>
    ...
    <xsl:template name="getLanugageTermfrom">
        ...
        <xsl:variable name="length" select="normalize-space(translate(replace($controlField008-35-37p, '(\d+[a-z]\d+\D+\|{4,}o\|{4,})([a-z]{3})(\|\|$)', '$2'), '|', ''))"/>
        <xsl:variable name="controlField008" select="marc:controlfield[@tag = '008']"/>
        <xsl:variable name="controlField008-36-38v" select="normalize-space(translate(substring($controlField008, 36, 3), '|', ' '))"/>
        <xsl:variable name="controlField008-35-37v" select="normalize-space(translate(substring($controlField008, 35, 3), '|', ' '))"/>
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:analyze-string select="substring($controlField008, 34, last())" regex="([a-z]{{3}})(\|\|)$">
                    <xsl:matching-substring>
                        <language>
                            <languageTerm authority="iso639-2b" type="code">
    ...
    <xd:doc>
        <xd:desc> match marc:datafield</xd:desc>
    </xd:doc>
...
<!--                <xsl:call-template name="nameIdentifier"/>-->
    ...
    <xsl:template name="createNameFrom720">
        <!-- 1.91 FLVC correction: the originalif test will fail because of xpath: the current node (from the for-each above) is already the 720 marc:datafield -->
...
&lt;/xsl:template&gt;-->
    ...
    <xsl:template name="createSubGeoFrom043">
        <subject>
            ...
            <xsl:for-each select="marc:subfield[@code = 'a' or @code = 'b' or @code = 'c']">
                <!-- enumeration value must be one of the following: marcgac, marccountry or iso3166 -->
                <geographicCode authority="{if (@code = 'a') then 'marcgac' else if (@code='b') then 'marcgac' else if (@code = 'c') then 'iso3166' else ''}">
    ...
    <xsl:template name="createSubTopFrom650" xmlns:xlink="http://www.w3.org/1999/xlink">
<xsl:if test="@ind2='7'">
...
<!--                </xsl:variable>
                <xsl:when test="starts-with($topicTerm, '(OCoLC)')">
                    <xsl:value-of select="replace($topicTerm, '\(OColc\)fst00(\d+)', 'https://id.worldcat.org/fast/$1')"/>                    
                </xsl:when>-->
    ...
    <xsl:template name="createSubFrom653" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <xsl:template name="createNoteFrom910" match="marc:datafield[@tag = '910']/marc:subfield[@code = 'a' or @code = 'b']">
    ...
    <xd:doc>
        <xd:desc>
            ...
            <xd:ul>
                ...
                <xd:li>(930$b) Insertion, (this is updated here)</xd:li>
    ...
    <xsl:template name="createNoteFrom930" match="marc:datafield[@tag = '930']/marc:subfield[@code = 'a' or @code = 'b' or @code = 'c']">
        <xsl:if test="marc:datafield[@tag = '930']">
            <note type="saleTape">
                ...
                <xsl:text>&#xa0;</xsl:text>
                <!-- 1.208 -->
                <xsl:value-of select="if (marc:datafield[@tag = '930'][1]/marc:subfield[@code = 'b'][1] = '00000000') then replace(string(current-date()), '(\d{4})-(\d{2})-(\d{2})-\d{2}:00','$1$2$3') else marc:datafield[@tag = '930']/marc:subfield[@code = 'b']"/>
                <xsl:text>&#xa0;</xsl:text>
    ...
    <xd:doc>
        <xd:desc>
            <xd:p><xd:b>AGRICOLA "saleTape" dates (historical): </xd:b>History date</xd:p>
            <xd:ul>
                <xd:li>(939$a) Selection,</xd:li>
                <xd:li>(939$b) Insertion and</xd:li>
                <xd:li>(939$c) Deletion </xd:li>
            </xd:ul>
        </xd:desc>
    </xd:doc>
    ...
    <xsl:template name="createNoteFrom945" match="marc:datafield[@tag = '945']/marc:subfield[@code = 'a' or @code = 'd' or @code = 'e']">
        ...
        <xsl:if test="/marc:collection/marc:record/marc:datafield[@tag = '856'][@ind2 != '2'][marc:subfield[@code = 'u']] and not(ends-with(f:deSequencing-items(marc:subfield[@code = 'u']), 'http://'))">
            ...
            <location>
                ...
                <url displayLabel="electronic resource">
                    ...
                    <!-- 1.184, 1.207 -->
                    <xsl:choose>
                    <xsl:when test="matches(marc:subfield[@code = 'u'][1],'https?://(dx\.)?doi.org/.*','i')">
                        <xsl:value-of select="f:percentEncode(replace(marc:subfield[@code = 'u'][1],'https?://(dx\.)?(doi.org/.*)','https://$2'))"/>
                    </xsl:when>
                        <xsl:when test="matches(marc:subfield[@code = 'u'][1],'https?://(\w+\.)?usda.gov/.*','i')">
                            <xsl:value-of select="f:percentEncode(replace(marc:subfield[@code = 'u'][1],'https?://(\w+\.)?(usda.gov/.*)','https://$2'))"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:if test="matches(marc:subfield[@code = 'u'][1], '^https?://')">
                                <xsl:value-of select="if (starts-with(marc:subfield[@code ='u'][1],'http')) then marc:subfield[@code='u'][1] else ''"/>
                            </xsl:if>
                        </xsl:otherwise>
                    </xsl:choose>
                </url>
    ...
    <xsl:template name="createAccessConditionFrom506" xmlns:xlink="http://www.w3.org/1999/xlink">
        <xsl:choose>
            ...
            <xsl:when test="matches(marc:subfield[@code='u'], 'http://purl.org/eprint/accessRights/[ORCpelsontArcid]+')">
                <accessCondition type="restriction on access" xlink:href="{marc:subfield[@code='u']}" displayLabel="Access Status">
                    <xsl:value-of select="marc:subfield[@code='a']"/>
                </accessCondition>
            </xsl:when>
        </xsl:choose>
...
<!-\-     -\->
  ...
  <!--  <xsl:template name="createAccessConditionFrom540">
    ...
    <xsl:template name="originInfo">
        ...
        <xsl:variable name="dataField260c">
            ...
            <xsl:call-template name="chopPunctuationStrings">
                <xsl:with-param name="chopStrings" select="marc:datafield[@tag = '260']/marc:subfield[@code = 'c']"/>
            </xsl:call-template>
        </xsl:variable>
       ...
       <!-- f:decodeMARCCountry() deprecated -->
       <!--</xsl:when>
            <xsl:otherwise>
       ...
       -->
                ...
                <xsl:when test="($controlField008-6 = 'e' or $controlField008-6 = 'p' or $controlField008-6 = 'r' or $controlField008-6 = 's' or $controlField008-6 = 't') and not($marcLeader6 = 'd' or $marcLeader6 = 'f' or $marcLeader6 = 'p' or $marcLeader6 = 't')">
                    ...
                    <xsl:choose>
                        <xsl:when test="matches($NALcontrolfield008, '(\d+)(\w)(.*)')">
                            <xsl:analyze-string select="substring($NALcontrolfield008, 1, 15)" regex="(\d+)(\w)(\d+)">
                                <xsl:matching-substring>
                                    <dateIssued encoding="w3cdtf" keyDate="yes">
                                        <xsl:choose>
                                            <!--YYYY-MM-DD-->
                                            <xsl:when test="matches(regex-group(3), '\d{8}')">
                                                <xsl:number value="substring(regex-group(3), 1, 4)" format="0001"/>
                                                <xsl:text>-</xsl:text>
                                                <xsl:number value="substring(regex-group(3), 5, 2)" format="01"/>
                                                <xsl:text>-</xsl:text>
                                                <xsl:number value="substring(regex-group(3), 7, 2)" format="01"/>
                                            </xsl:when>
            ...
            <!-- issuance -->
            <!--1.179 -->
            <xsl:if test="marc:subfield[@code = 'h'] and marc:datafield[@tag = '655']/marc:subfield[@code = 'a'] != 'article' or not(matches(marc:datafield[@tag = '773'][1]/marc:subfield[@code = 'x'][1], '\d{4}\-\d{3}.'))">
                <!-- 1.120 - @260$ -->
                <!-- 1.158 -->
                <xsl:for-each select="marc:leader">
                    <xsl:if test="
                        ...
                        <issuance>
                            <xsl:choose>
                                <xsl:when test="$marcLeader7 = 'a' or $marcLeader7 = 'c' or $marcLeader7 = 'd' or $marcLeader7 = 'm'">monographic</xsl:when>
                                <!-- <xsl:when test="$marcLeader7 = 'b'">continuing</xsl:when> -->
                                <xsl:when test="$marcLeader7 = 'm' and ($marcLeader19 = 'a' or $marcLeader19 = 'b' or $marcLeader19 = 'c')">multipart monograph</xsl:when>
                                <!-- 1.106 20141218 -->
    ...
    <xsl:template match="marc:datafield[@tag = '260'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '260')]" mode="originInfo">
        ...
        <xsl:for-each select="marc:subfield[@code = 'c'][position()]">
            <xsl:if test="$marcLeader6 = 'd' or $marcLeader6 = 'f' or $marcLeader6 = 'p' or $marcLeader6 = 't'">
                <dateCreated>
                    <xsl:call-template name="chopPunctuation">
                        <xsl:with-param name="chopString" select="."/>
    ...
    <xd:doc>
        <xd:desc>match marc:datafield[@tag = '033'] originInfo Info </xd:desc>
    </xd:doc>
