<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3"
	...
	xmlns:f="http://functions" xmlns:local="http://wwww.local.gov/namespace"
	exclude-result-prefixes="marc f local xlink" version="2.0">
	...
	<!-- Build marc:record -->
	<xsl:template match="marc:record" mode="root">
