...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
	...
	<xsl:include href="tempNAL-MARC21slimUtils.xsl"/>
	...
	<xd:doc>
		<xd:desc> Builds paths for transformation </xd:desc>
				...
				<xsl:when test="//marc:collection/marc:record">
					<modsCollection xmlns="http://www.loc.gov/mods/v3" xmlns:mods="http://www.loc.gov/mods/v3"
						...
						<xsl:for-each select="//marc:collection/marc:record">
								<xsl:apply-templates select="//marc:record" mode="marc"/>
						</xsl:for-each>
					</modsCollection>
				</xsl:when>
				<xsl:otherwise>					
	...
	<xd:doc>
		<xd:desc> Empty template for holdings </xd:desc>
	</xd:doc>
	<xsl:template match="marc:record[@type = 'Holdings']"/>
	
	<xd:doc>
		<xd:desc> Build marc:record </xd:desc>
	</xd:doc>
	<xsl:template match="marc:record" mode="marc">
		...
		<mods version="3.7">
			...
			<xsl:if test="/marc:record">
				...
				<xsl:attribute name="xsi:schemaLocation">http://www.loc.gov/mods/v3
					http://www.loc.gov/standards/mods/v3/mods-3-6.xsd</xsl:attribute>
			</xsl:if>
			...
			<xsl:apply-templates select="
					marc:datafield[@tag = '264'][@ind2 = '0' or @ind2 = '1' or @ind2 = '2' or @ind2 = '3']
		...
		-->
			<xsl:apply-templates select="
					marc:datafield[@tag = '245'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '245')]
			...
			<!-- 6XX: subjects -->
			<xsl:apply-templates select="
					marc:datafield[@tag = '600'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '600')]
			...
			<xsl:apply-templates
				...
				mode="relatedItem"/>
			<xsl:apply-templates
				select="marc:datafield[@tag = '700'][marc:subfield[@code = 't']] | marc:datafield[@tag = '880'][marc:subfield[@code = 't']][starts-with(marc:subfield[@code = '6'], '700')]"
				mode="relatedItem"/>
			<xsl:apply-templates
				select="marc:datafield[@tag = '710'][marc:subfield[@code = 't']] | marc:datafield[@tag = '880'][marc:subfield[@code = 't']][starts-with(marc:subfield[@code = '6'], '710')]"
				mode="relatedItem"/>
			<xsl:apply-templates
				select="marc:datafield[@tag = '711'][marc:subfield[@code = 't']] | marc:datafield[@tag = '880'][marc:subfield[@code = 't']][starts-with(marc:subfield[@code = '6'], '711')]"
				mode="relatedItem"/>
			<xsl:apply-templates
				select="marc:datafield[@tag = '730'][@ind2 = '2'] | marc:datafield[@tag = '880'][@ind2 = '2'][starts-with(marc:subfield[@code = '6'], '730')]"
				mode="relatedItem"/>
			<xsl:apply-templates
				select="marc:datafield[@tag = '740'][@ind2 = '2'] | marc:datafield[@tag = '880'][@ind2 = '2'][starts-with(marc:subfield[@code = '6'], '740')]"
				mode="relatedItem"/>
			<!--2.32 - @777,@787 -->
			<xsl:apply-templates select="
			...
			<xsl:apply-templates
				...
				mode="relatedItem"/>
			<xsl:apply-templates
				select="marc:datafield[@tag = '856'][@ind2 = '2'] | marc:datafield[@tag = '880'][@ind2 = '2'][starts-with(marc:subfield[@code = '6'], '856')]"
				mode="relatedItem"/>
	...
	<xd:doc>
		<xd:desc> 130, 730 titleInfo uniform</xd:desc>
	</xd:doc>
	<xsl:template match="
			marc:datafield[@tag = '130'] | marc:datafield[@tag = '880'][@ind2 != '2'][starts-with(marc:subfield[@code = '6'], '130')]
	...
	<xd:doc>
		<xd:desc> 210 titleInfo type abbreviated</xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 242 titleInfo translated </xd:desc>
	</xd:doc>
		...
		<titleInfo type="translated">
			...
			<xsl:choose>
				...
				<xsl:when test="@ind2 != ' ' and @ind2 &gt; 0">
					...
					<nonSort xml:space="preserve"><xsl:value-of select="
								substring(local:stripPunctuation($title), 1, (if (@ind2 castable as xs:integer) then
									@ind2 cast as xs:integer
								else
									0))"/> </nonSort>
					<title>
						<!-- 2.32 - @245/@880$ind2 -->
						<xsl:value-of select="
								substring(local:stripPunctuation($title), (if (@ind2 castable as xs:integer) then
									@ind2 cast as xs:integer
								else
									0) + 1)"/>
					</title>
	...
	<xd:doc>
		<xd:desc> 245 titleInfo main entry </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 246 titleInfo type alternative </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 740 titleInfo alternative </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> $b titleInfo, subtitle </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> $n titleInfo, partNumber </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> $p titleInfo, partName </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> 2.11 ws: added test to only output name element if no subfield t exists. </xd:desc>
	</xd:doc>
	<xsl:template match="
			marc:datafield[@tag = '100'][not(marc:subfield[@code = 't'])] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '100')][not(marc:subfield[@code = 't'])]
		...
		<name>
			...
			<!-- @100/@880-usage -->
			<xsl:if
				test="@tag = '100' or .[@tag = '880'][starts-with(marc:subfield[@code = '6'], '100')][not(marc:subfield[@code = 't'])]">
			...
			<xsl:for-each select="marc:subfield[@code = 'a']">
				<namePart>
					<!-- 2.38 -->
				<xsl:apply-templates select="marc:datafield[@tag = '100' or @tag = '700']/not(marc:subfield[@code = 't'])">
						<xsl:with-param name="name"/>
						<xsl:with-param name="nameIdentifier"/>
					</xsl:apply-templates>
				</namePart>
			</xsl:for-each>
	...
	<xsl:template match="marc:datafield[@tag='100' or @tag='700']" mode="personal_name">
			<xsl:param name="name">
	...
	<xd:doc>
		<xd:desc> 110 710 name</xd:desc>
	</xd:doc>
	<xsl:template match="
			marc:datafield[@tag = '110'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '110')]
	...
	<xd:doc>
		<xd:desc> Type of resource </xd:desc>
		<xd:param name="leader"/>
		<xd:param name="leader6"/>
		<xd:param name="leader7"/>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> 047, 336, 655 Genre datafields </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 2.12 ws: added new genre template for 336 field </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 2.44 originInfo </xd:desc>
		<xd:param name="leader6"/>
		<xd:param name="leader7"/>
		<xd:param name="leader19"/>
		<xd:param name="controlField008"/>
		<xd:param name="typeOf008"/>
	</xd:doc>
	<xsl:template name="originInfo">
		...
		<xsl:variable name="dataField260c"
			select="local:stripPunctuation(marc:datafield[@tag = 260]/marc:subfield[@code = 'c'])"/>
	...
	<xsl:template
		match="marc:datafield[@tag = '264'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '264')]"
		mode="originInfo">
	...
	<xd:doc>
		<xd:desc> Concats all altRepGroup numbers together </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> 2.44 depreciated </xd:desc>
	</xd:doc>
	<xsl:template name="z2xx880">
		...
		<xsl:variable name="zx880" select="
				if ($x250 != '' and $x260 != '') then
					concat($x250, $x260)
				else
					if ($x250 != '') then
						$x250
	...
	<xd:doc>
		<xd:desc> originInfo date 046 033 </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 2.44 originInfo edition </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 008 041 Language elements </xd:desc>
	</xd:doc>
						...
						<language>
							...
							<xsl:choose>
								...
								<xsl:when test="@code = 'd'">
									<xsl:attribute name="objectPart">sung or spoken
										text</xsl:attribute>
								</xsl:when>
								...
								<xsl:when test="@code = 'f'">
									<xsl:attribute name="objectPart">table of
										contents</xsl:attribute>
								</xsl:when>
								...
								<xsl:when test="@code = 'j'">
									<xsl:attribute name="objectPart">subtitle or
										caption</xsl:attribute>
								</xsl:when>
							</xsl:choose>
							<languageTerm>
								<!-- Adds appropriate type and authority attributes -->
	...
	<xd:doc>
		<xd:desc> 2.43 physicalDescription  </xd:desc>
		<xd:param name="typeOf008"/>
		<xd:param name="controlField008"/>
		<xd:param name="leader6"/>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> For Physical Description linking fields </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> 2.12 ws: added field 337
			2.15 tmee: added authority attribute for $2</xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 2.12 ws: added field 338
			2.15 tmee: added authority attribute for $2</xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 520 Create abstract </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 505 Create table of contents element </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 008 521 Create targetAudience </xd:desc>
		<xd:param name="typeOf008"/>
		<xd:param name="controlField008"/>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc>506 540 Create accessCondition</xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 245 362 5xx Create notes </xd:desc>
	</xd:doc>
	<xsl:template
		match="marc:datafield[@tag = '245'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '245')]"
		mode="note">
	...
	<xd:doc>
		<xd:desc> General Note field </xd:desc>
	</xd:doc>
	<xsl:template match="
			marc:datafield[@tag = '500'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '500')]
	...
	<xd:doc>
		<xd:desc> Suppresses any note fields not specifically matched above </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> 034 cartographics </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 255 subject cartographics </xd:desc>
	</xd:doc>
	<xsl:template match="
			marc:datafield[@tag = '255'][child::*[@code = 'a' or @code = 'b' or @code = 'c']]
	...
	<xd:doc>
		<xd:desc> 043 geographicCode </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 045 subject temporal </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 600 610 611 name </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 630: subject title </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 648: subject temporal </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 650: subject topic </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 651: subject geographic </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 653: subject, topics (Uncontrolled) </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 656: subject, occupation </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> 662 and 752; hierarchical geographic </xd:desc>
	</xd:doc>
	<xsl:template match="
			marc:datafield[@tag = '662'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '662')]
			| marc:datafield[@tag = '752'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '752')]"
	...
	<xd:doc>
		<xd:desc> subfield a and q: namePart </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfields b or c: termsOfAddress </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfield b: name type='date' </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfield u: affiliation </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfields e and 4: role </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfield v: genre </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfield x: topic </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfield y: temporal </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfield z: geographic </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> subfield t: titleInfo </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> Creates authority attribute for mods subject elements based on ind2 attribute.  </xd:desc>
	</xd:doc>
	<xsl:template name="subjectAuthority">
		<xsl:choose>
			...
			<xsl:when test="@ind2 = '3'">
				<xsl:attribute name="authority">atg</xsl:attribute>
			</xsl:when>
	...
	<xd:doc>
		<xd:desc> Classification templates </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xd:doc>
		<xd:desc> Create location templates: 852 856 </xd:desc>
	</xd:doc>
	<xsl:template
	...
	<xsl:template
		match="marc:datafield[@tag = '490'][@ind1 = '0' or @ind1 = ' '] | marc:datafield[@tag = '880'][@ind1 = '0' or @ind1 = ' '][starts-with(marc:subfield[@code = '6'], '490')]"
		mode="relatedItem">
			...
			<relatedItem type="series">
				<xsl:for-each
					...
					<titleInfo>
						...
						<title>
							<xsl:value-of
								select="local:stripPunctuation(local:subfieldSelect(., 'a'))"/>
						</title>
						<xsl:if test="marc:subfield[@code = 'v']">
							<partNumber>
								<xsl:value-of
									select="local:stripPunctuation(marc:subfield[@code = 'v'])"/>
							</partNumber>
						</xsl:if>
					</titleInfo>
				</xsl:for-each>
	...
	<xsl:template
		match="marc:datafield[@tag = '440'] | marc:datafield[@tag = '880'][@ind1 = '0' or @ind1 = ' '][starts-with(marc:subfield[@code = '6'], '440')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
				...
				<xsl:for-each
					...
					<titleInfo>
						...
						<xsl:if test="marc:subfield[@code = 'v']">
							<partNumber>
								<xsl:value-of
									select="local:stripPunctuation(local:subfieldSelect(., 'v'))"/>
							</partNumber>
						</xsl:if>
					</titleInfo>
				</xsl:for-each>
	...
	<xsl:template
		match="marc:datafield[@tag = '510'][@ind1 = '0' or @ind1 = ' '] | marc:datafield[@tag = '880'][@ind1 = '0' or @ind1 = ' '][starts-with(marc:subfield[@code = '6'], '510')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
					...
					<xsl:if test="marc:subfield[@code = 'c']">
						<part>
							...
							<detail type="part">
								<number>
									<xsl:value-of
										select="local:stripPunctuation(local:subfieldSelect(., 'c'))"
									/>
								</number>
							</detail>
						</part>
	...
	<xsl:template
		match="marc:datafield[@tag = '534'][@ind1 = '0' or @ind1 = ' '] | marc:datafield[@tag = '880'][@ind1 = '0' or @ind1 = ' '][starts-with(marc:subfield[@code = '6'], '534')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
	...
	<xsl:template
		match="marc:datafield[@tag = '700'][marc:subfield[@code = 't']] | marc:datafield[@tag = '880'][marc:subfield[@code = 't']][starts-with(marc:subfield[@code = '6'], '700')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
			...
			<relatedItem>
				...
				<xsl:for-each
					...
					<name type="personal">
						...
						<xsl:apply-templates select="marc:subfield[@code = 'd']" mode="nameDate"/>
						<xsl:apply-templates
							select="marc:subfield[@code = 'e'] | marc:subfield[@code = '4']"
							mode="role"/>
					</name>
	...
	<xsl:template
		match="marc:datafield[@tag = '710'][marc:subfield[@code = 't']] | marc:datafield[@tag = '880'][marc:subfield[@code = 't']][starts-with(marc:subfield[@code = '6'], '710')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
	...
	<xsl:template
		match="marc:datafield[@tag = '711'][marc:subfield[@code = 't']] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '711')][marc:subfield[@code = 't']]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
	...
	<xsl:template
		match="marc:datafield[@tag = '730'][@ind2 = '2'] | marc:datafield[@tag = '880'][@ind2 = '2'][starts-with(marc:subfield[@code = '6'], '730')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
	...
	<xsl:template
		match="marc:datafield[@tag = '740'][@ind2 = '2'] | marc:datafield[@tag = '880'][@ind2 = '2'][starts-with(marc:subfield[@code = '6'], '740')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
				...
				<xsl:for-each
					...
					<xsl:if test="@tag = '773'">
						<xsl:for-each select="marc:subfield[@code = 'g']">
							<part>
								<xsl:call-template name="xxs880"/>
								<xsl:call-template name="NALrelatedPart"/>
							</part>
						</xsl:for-each>
	...
	<xd:doc>
		<xd:desc>NAL relatedPart</xd:desc>
	</xd:doc>
	<xsl:template name="NALrelatedPart"
		match="marc:datafield[@tag = '773']/marc:subfield[@code = 'g']" mode="NAL-relatedPart">

		<xsl:call-template name="xxs880"/>
		<xsl:analyze-string select="." regex="(\d+)\s?(\w+)?\.?\s?(\d+)?(.+)">
					...
					<xsl:when
						...
						<extent unit="pages">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:if test="$eStartPageForTotal >= $eStartPageForTotal">
										<total>
											<xsl:value-of
	...
	<xsl:template
		match="marc:datafield[@tag = '800'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '800')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
	...
	<xsl:template
		match="marc:datafield[@tag = '810'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '810')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
	...
	<xsl:template
		match="marc:datafield[@tag = '811'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '811')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
	...
	<xsl:template
		match="marc:datafield[@tag = '830'] | marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '830')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
	...
	<xsl:template
		match="marc:datafield[@tag = '856'][@ind2 = '2'] | marc:datafield[@tag = '880'][@ind2 = '2'][starts-with(marc:subfield[@code = '6'], '856')]"
		mode="relatedItem">
		<xsl:variable name="s6"
			select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
		<xsl:if
			test="@tag = 856 or (@tag = '880' and not(../marc:datafield[@tag = '856'][@ind2 = '2'][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
			<relatedItem>
				<xsl:for-each
	...
	<xsl:template match="marc:subfield[@code = 'g']" mode="relatedItem">
		<xsl:if test="
				parent::marc:datafield[@tag = '760' or @tag = '762' or @tag = '765'
	...
	<xd:doc>
		<xd:desc> @800$p NOTE: does not output for 800, check mapping</xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> Creates related item names </xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> Create Identifiers </xd:desc>
	</xd:doc>
	<xsl:template
		...
		<xsl:choose>
					...
					<xsl:attribute name="type">
						<xsl:choose>
							<xsl:when test="starts-with(., 'urn:doi') or starts-with(., 'doi')"
								>doi</xsl:when>
							<xsl:when
								test="starts-with(., 'urn:hdl') or starts-with(., 'hdl') or starts-with(., 'http://hdl.nal.gov')"
								>hdl</xsl:when>
						</xsl:choose>
					</xsl:attribute>
					<xsl:value-of select="concat('hdl:', substring-after(., 'http://hdl.nal.gov/'))"
					/>
				</identifier>
			</xsl:when>
			<xsl:when test="starts-with(., 'urn:hdl') or starts-with(., 'hdl')">
				<identifier type="hdl">
					...
					<xsl:value-of select="concat('hdl:', ., 'http://hdl.nal.gov/')"/>
				</identifier>
			</xsl:when>
		</xsl:choose>
	</xsl:template>
	...
	<xd:doc>
		<xd:desc> Named template used by relatedItem</xd:desc>
	</xd:doc>
	...
	<xd:doc>
		<xd:desc> Generates xlink:href attribute </xd:desc>
	</xd:doc>
